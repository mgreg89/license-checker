...
var flatten = function(options) {
	...
	if(options._args.packageoverrides && options._args.packageoverrides[moduleInfo.name + '@'+moduleInfo.version]) {
		console.warn("[WARN] CHANGING package license of", moduleInfo.name + '@'+moduleInfo.version, 'to', options._args.packageoverrides[moduleInfo.name + '@'+moduleInfo.version]);

		licenseData = options._args.packageoverrides[moduleInfo.name + '@'+moduleInfo.version];
	}
...
exports.init = function(options, callback) {
	...
	if (options.packageoverrides) {
        options.packageoverrides = this.parseJson(options.packageoverrides);
    }
